...
import { Home, User, FolderOpen, Award, Mail, Github, Linkedin, Menu, X, Instagram, Twitter, Image, BookOpen, LogIn, LogOut, Briefcase, Code2, FileText } from "lucide-react";
    ...
    <>
      ...
      `}>
        <div className="flex flex-col h-full p-6">
          ...
          {/* Social Links */}
          <div className="mt-auto pt-6 border-t border-portfolio-border">
            <p className="text-xs text-portfolio-text-muted mb-3 uppercase tracking-wider">Follow Me</p>
            <div className="flex flex-wrap gap-3 mb-4">
              <a
                href="https://github.com/Nihal108-bi"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-lg bg-portfolio-bg text-portfolio-text-muted hover:text-portfolio-accent hover:bg-portfolio-accent/10 transition-all duration-300"
                title="GitHub"
              >
            ...
            <p className="text-xs text-portfolio-text-muted font-medium tracking-wide">
              ✨ © 2025 Nihal Jaiswal ✨
            </p>
          </div>
        </div>
