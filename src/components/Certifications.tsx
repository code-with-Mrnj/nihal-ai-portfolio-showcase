              ...
              <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredCerts.map((cert, index) => (
                  <StaggerItem key={index}>
                    <Card className="bg-portfolio-surface border-portfolio-border hover:border-portfolio-accent transition-all duration-300 hover:shadow-glow group h-full">
              ...
              <div>
                ...
                <StaggerContainer className="space-y-4">
                  {otherCerts.map((cert, index) => (
                    <StaggerItem key={index}>
                      <Card className="bg-portfolio-surface border-portfolio-border hover:border-portfolio-accent transition-all duration-300">
                        <CardContent className="p-6">
